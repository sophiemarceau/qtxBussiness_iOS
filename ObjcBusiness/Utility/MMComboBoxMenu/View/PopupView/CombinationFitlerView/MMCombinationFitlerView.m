...
//            CGFloat left = ((i == 0)?ButtonHorizontalMargin:self.width - ButtonHorizontalMargin - 100);
            ...
            UIColor *titleColor = ((i == 0)?FontUIColorGray:[UIColor whiteColor]);
            UIColor *buttonbackgroundcolor = ((i == 0)?[UIColor clearColor]:[UIColor colorWithHexString:titleSelectedColor]);
