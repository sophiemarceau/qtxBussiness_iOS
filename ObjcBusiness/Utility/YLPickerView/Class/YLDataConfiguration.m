...
- (void)getDefaultDataWithType:(YLDataConfigType)type
{
    switch (type) {
        ...
        case YLDataConfigTypeAddress:{
            NSString *provincePath = [[NSBundle mainBundle]pathForResource:@"province1" ofType:@"json"];
...
{
    NSString *cityPath = [[NSBundle mainBundle]pathForResource:@"city1" ofType:@"json"];
...
{
    NSString *areaPath = [[NSBundle mainBundle]pathForResource:@"area1" ofType:@"json"];
