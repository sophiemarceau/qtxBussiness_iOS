...
- (MOSTwoColumnPicker *)tradeTwoColumnPicker {
    if (!_tradeTwoColumnPicker) {
        _tradeTwoColumnPicker = [MOSTwoColumnPicker new];
    }
    return _tradeTwoColumnPicker;
}
// ================================DatePicker===================================//
...
- (void)show2CloumnTradePickerWithTitle:(NSString *)title cancelTitle:(NSString *)cancelTitle commitTitle:(NSString *)commitTitle commitBlock:(void(^)(NSString *address, NSString *zipcode))commitBlock cancelBlock:(void(^)())cancelBlock {
    self.tradeTwoColumnPicker.toolBar.titleBarTitle = title;
    self.tradeTwoColumnPicker.toolBar.cancelBarTitle = cancelTitle;
    self.tradeTwoColumnPicker.toolBar.commitBarTitle = commitTitle;
    [self.tradeTwoColumnPicker show2ColumnTradePickerCommitBlock:^(NSString *address, NSString *zipcode) {
        if (commitBlock) {
