...
-(UILabel *)commisionLabel{
    if (_commisionLabel == nil) {
         self.commisionLabel =  [CommentMethod createLabelWithText:@"" TextColor:FontUIColorBlack BgColor:[UIColor clearColor] TextAlignment:NSTextAlignmentLeft Font:12*AUTO_SIZE_SCALE_X];
