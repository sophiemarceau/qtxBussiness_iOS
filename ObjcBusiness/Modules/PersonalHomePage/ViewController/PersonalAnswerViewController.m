//
//  PersonalAnswerViewController.m
//  ObjcBusiness
//
...
@interface PersonalAnswerViewController ()<UITableViewDelegate,UITableViewDataSource,HeaderViewDelegate>

@end

@implementation PersonalAnswerViewController
