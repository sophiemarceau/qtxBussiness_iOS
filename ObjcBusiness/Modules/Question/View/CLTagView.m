...
//    cl_colorWithHex(0xf0eff3);
    
    UILabel *titleLabel = [[UILabel alloc] init];
    self.titleLabel = titleLabel;
    titleLabel.text = @"";
    titleLabel.font = [UIFont systemFontOfSize:kCLRecentTitleFont];
    titleLabel.textColor = FontUIColor999999Gray;
    titleLabel.backgroundColor = [UIColor whiteColor];
//    cl_colorWithHex(0x8a949b);
    [headView addSubview:titleLabel];
    
    titleLabel.translatesAutoresizingMaskIntoConstraints = NO;
    [headView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-left-[titleLabel]-0-|" options:0 metrics:@{@"left": @(15)} views:NSDictionaryOfVariableBindings(titleLabel)]];
    ...
    tagsShowView.backgroundColor = [UIColor whiteColor];
