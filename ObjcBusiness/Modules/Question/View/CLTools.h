...
#define kCLTagFont 15                 // 标签文字的大小
#define kCLDistance 15                // 上下两个标签的间隙
#define kCLTextFieldGap 20             // 标签中，文字距离顶部边界线(4)与底部边界线(4)的距离（ 4 + 4 = 8）
...
#define kCLTagViewHorizontaGap 15     // 标签展示页水平两端的与标签的距离
#define kCLDashesBorderWidth 0.8f     // 标签的borderWidth

// 标签展示页
#define kCLTag_Normal_TextColor cl_colorWithHex(0xF93630)      // 标签默认文本颜色
#define kCLTag_Selected_TextColor [UIColor whiteColor]         // 标签选中状态下文本颜色
#define kCLTag_Normal_BorderColor cl_colorWithHex(0xF93630)    // 标签默认border颜色
#define kCLTag_Selected_BorderColor cl_colorWithHex(0xF93630)  // 标签选中状态下border颜色
#define kCLTag_Normal_BackgroundColor [UIColor whiteColor]        // 标签默认背景颜色
#define kCLTag_Selected_BackgroundColor cl_colorWithHex(0xF93630) // 标签选中状态下背景颜色

// 最近标签页
#define kCLHeadViewdHeight 44                   // 最近标签页title的高度
#define kCLRecentTitleFont 12                   // 最近标签页title的font

#define kCLRecentTag_Normal_TextColor cl_colorWithHex(0x474747)    // 标签默认文本颜色
#define kCLRecentTag_Selected_TextColor cl_colorWithHex(0xF93630)  // 标签选中状态下文本颜色
#define kCLRecentTag_Normal_BorderColor cl_colorWithHex(0xdadadd)  // 标签默认border颜色
#define kCLRecentTag_Selected_BorderColor cl_colorWithHex(0xF93630)// 标签选中状态下border颜色
