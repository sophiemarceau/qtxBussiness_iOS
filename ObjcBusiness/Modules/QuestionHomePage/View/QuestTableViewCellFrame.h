...
@interface QuestTableViewCellFrame : NSObject
@property(nonatomic,strong)QuestModel *questModel;
...
@property(nonatomic,assign,readonly)CGRect questBgFrame;
